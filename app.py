...
# --- Configuration ---
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:kousik@localhost:5432/student'
...
API_KEY = "AIzaSyD4pjzOkbSx5sHAnVP2jXl2C0n1FD8fh7M" # IMPORTANT: Add your Gemini API Key here if you have one
